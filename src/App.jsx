...
import { isAuthenticated as checkAuth, logout as performLogout } from './utils/authUtils.js';
...
function AppContent() {
  ...
  useEffect(() => {
    ...
    // Check on initial mount and focus
    sync();
    
    window.addEventListener('storage', sync);
    window.addEventListener('focus', sync);
    
    // Periodic check every minute to handle token expiration
