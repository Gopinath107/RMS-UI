    ...
    <div className="p-6 space-y-6">
      ...
      >
        <Card className="bg-white/90 backdrop-blur-sm border-0 shadow-xl rounded-lg overflow-hidden">
          <div className="relative max-h-[480px] overflow-auto scrollbar-thin scrollbar-track-sky-100 scrollbar-thumb-sky-300 hover:scrollbar-thumb-sky-400">
            <Table>
          ...
          {/* Enhanced Pagination */}
          <div className="flex items-center justify-between p-4 bg-gradient-to-r from-sky-50/80 to-blue-50/60 border-t border-sky-200 backdrop-blur-sm">
